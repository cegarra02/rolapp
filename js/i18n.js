...
const I18N_EN = {
  ...
  'Dominante': 'Dominant', 'Sumiso': 'Submissive', 'Yandere': 'Yandere', 'Tsundere': 'Tsundere',
  'Kuudere': 'Kuudere', 'Princesa': 'Princess', 'Príncipe': 'Prince', 'Reina': 'Queen', 'Rey': 'King',
  'Caballero': 'Knight', 'Mago': 'Wizard', 'Bruja': 'Witch', 'Guerrero': 'Warrior', 'Asesino': 'Assassin',
  'Ladrón': 'Thief', 'Pirata': 'Pirate', 'Detective': 'Detective', 'Médico': 'Doctor', 'Doctora': 'Doctor',
  'Profesor': 'Teacher', 'Profesora': 'Teacher', 'Estudiante': 'Student', 'Jefe': 'Boss', 'Jefa': 'Boss',
  'Famoso': 'Celebrity', 'Famosa': 'Celebrity', 'Músico': 'Musician', 'Artista': 'Artist',
  'Militar': 'Military', 'Policía': 'Police', 'Criminal': 'Criminal', 'Mafioso': 'Mafia', 'Mafia': 'Mafia',
  'Vampiro': 'Vampire', 'Vampiresa': 'Vampire', 'Hombre lobo': 'Werewolf', 'Demonio': 'Demon',
  'Ángel': 'Angel', 'Elfo': 'Elf', 'Elfa': 'Elf', 'Robot': 'Robot', 'IA': 'AI', 'Diosa': 'Goddess',
  'Dios': 'God', 'Superhéroe': 'Superhero', 'Villano': 'Villain', 'Villana': 'Villain',
  'Medieval': 'Medieval', 'Futurista': 'Futuristic', 'Cyberpunk': 'Cyberpunk', 'Apocalíptico': 'Apocalyptic',
  'Postapocalíptico': 'Post-apocalyptic', 'Guerra': 'War', 'Crimen': 'Crime', 'Psicológico': 'Psychological',
  'Erótico': 'Erotic', 'Harem': 'Harem', 'Prohibido': 'Forbidden', 'Tabú': 'Taboo', 'Celoso': 'Jealous',
  'Posesivo': 'Possessive', 'Protector': 'Protective', 'Frío': 'Cold', 'Tímido': 'Shy', 'Maduro': 'Mature',
  'Inocente': 'Innocent', 'Fantasma': 'Ghost', 'Monstruo': 'Monster', 'Sobrenatural': 'Supernatural',
  'Aventurero': 'Adventurer', 'Idol': 'Idol', 'Jefe del crimen': 'Crime boss', 'Best friend': 'Best friend',
  'Mejor amigo': 'Best friend', 'Mejor amiga': 'Best friend', 'Novio': 'Boyfriend', 'Novia': 'Girlfriend',
  'Esposo': 'Husband', 'Esposa': 'Wife', 'Compañero': 'Companion', 'Rival': 'Rival',
};
